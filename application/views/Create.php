...
<a href="#" class="close" data-dismiss="alert" aria-label="close">close</a>
    ...
    <tbody>
        <div class="container">
            ...
            <td><?php echo form_open('crud/save',['class'=>'form-horizontal']);?>
                Customer Name <?php echo form_input(['name'=>'customerName',
                'class'=>'form-control','value'=> set_value('customerName')]);?>
            ...
            <td>City <?php echo form_input(['name'=>'city',
                'class'=>'form-control','value'=> set_value('city')]);?>
                 <?php echo form_error('city'); ?>
            </td>

            <td>Country <?php echo form_input(['name'=>'country',
                'class'=>'form-control','value'=> set_value('country')]);?>
